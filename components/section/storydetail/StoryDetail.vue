    ...
    <section class="story-detail">
        <div class="container">
            <div class="story-detail__header">
                ...
                <h1 class="story-detail__title">Guardians of the Galaxy Vol. 3</h1>

                <div class="story-detail__author">
                    <div class="story-detail__author-image-container">
                        <img src="https://picsum.photos/80/80?random=1" alt="Juliana Putra" class="story-detail__author-image">
                    </div>
            ...
            <div class="story-detail__body">
                <div class="story-detail__image-container">
                    <img src="https://picsum.photos/800/800?random=1" alt="" class="story-detail__image">
                </div>
